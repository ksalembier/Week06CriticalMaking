...
Shader "windShader"
{
	Properties
	{
		...
		[Toggle]_TimeManualToggle("Time/Manual Toggle", Float) = 1
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 appendResult7 = (float4(i.uv_texcoord.x , ( i.uv_texcoord.y + (( _TimeManualToggle )?( i.uv2_texcoord2.y ):( mulTime3 )) ) , 0.0 , 0.0));
...
/*ASEBEGIN
Version=19801
Node;AmplifyShaderEditor.RangedFloatNode;50;-2272,-144;Inherit;False;Property;_TimeScale;Time Scale;2;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;1;-2352,304;Inherit;False;1;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleTimeNode;3;-2112,-144;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;62;-1888,-224;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ToggleSwitchNode;20;-1872,144;Inherit;False;Property;_TimeManualToggle;Time/Manual Toggle;1;0;Create;True;0;0;0;False;0;False;1;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;2;-1584,0;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;61;-1104,-576;Inherit;False;Property;_Color0;Color 0;4;0;Create;True;0;0;0;False;0;False;0.7411765,0.9921569,0.909804,1;1,1,1,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;4;-864,32;Inherit;True;Property;_WindTexture;Wind Texture;0;0;Create;True;0;0;0;False;0;False;-1;434abb688ac0dac47a27a918861cfd5a;b3a65ffbf21d97d44bec79a9a68712d3;True;0;False;white;Auto;False;Object;-1;Derivative;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;21;-2400,144;Inherit;False;Property;_ManualWindPanning;Manual Wind Panning;3;0;Create;True;0;0;0;False;0;False;-1;-1;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;63;-1920,480;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
WireConnection;63;1;1;2
WireConnection;0;2;54;0
WireConnection;0;9;58;0
ASEEND*/
//CHKSM=AB2C1FDF09714DFDADEEE73EFF5B4B2F471980A7